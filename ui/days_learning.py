...
class DaysLearning(QWidget):
    ...
    def init_ui(self):
        ...
        main_layout.setContentsMargins(40, 20, 40, 40)  # Reduced top margin
        ...
        header_label.setFont(QFont("Segoe UI", 28, QFont.Bold))  # Increased font size
        ...
        grid_layout.setSpacing(20)  # Reduced spacing
